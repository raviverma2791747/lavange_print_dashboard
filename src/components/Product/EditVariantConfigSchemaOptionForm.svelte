      ...
      <div class="mb-4">
        ...
        <div class="flex gap-1">
          ...
          <select
            ...
            on:change={(e) => (variantSchemaOptionClone.type = e.target.value)}
          >
        ...
        <div class="flex flex-col gap-2">
          {#each variantSchemaOptionClone.options as option, index}
            <EditVariantConfigSchemaOptionValueForm
              ...
              disabledMoveDown={index === variantSchemaOptionClone.options.length - 1}
          ...
          <button
            ...
            on:click={handleEditVariantConfigSchemaOptionValue}
          >
            Add value
          </button>
        </div>
